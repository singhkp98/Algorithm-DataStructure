...
// compilazione: g++ -xc++ MinHeap.c 
//
// Obiettivo:
// 1) analisi rappresentazione albero completo <---> array
// 2) implementazione inserimento su heap OK
// 3) estrazione minimo con funzione "heapify" (discesa del valore minimo dalla radice)
...
int heap_remove_min(){
  ...
  //metto l'ultimo elemento dell'heap alla prima posizione e il primo elemento all'ultima 
  int t=heap[0];
