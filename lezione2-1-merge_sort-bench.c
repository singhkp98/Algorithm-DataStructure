...
// compilazione: g++ -xc++ lezione2-1-merge_sort-bench.c 
//
// esecuzioni
...
// come cambiano i confronti al variare della dimensione dell'array: divisione ricorsiva a volte chiede piu' confronti (rispetto al caso bilanciato)
// ./a.out 128 -d=128 -t=1
